...
namespace Pinwheel.Poseidon.JupiterPreview
{
    public static partial class JEditorCommon
    {
        ...
        public static Color linkColor = new Color32(125, 170, 240, 255);
        ...
        private class CommonLinksUtils
        {
            ...
            {
                JCommon.CONTACT_PAGE,
                JCommon.ONLINE_MANUAL,
                JCommon.POLARIS_LINK,
                JCommon.POSEIDON_LINK
            };
            ...
            private static GUIStyle GetMenuStyle()
            {
                ...
                s_MenuStyle.normal.textColor = linkColor;
                return s_MenuStyle;
            }
        ...
        public static void DrawCommonLinks()
        {
            CommonLinksUtils.DrawExternalLinks();
        }
    }
}
#endif  
